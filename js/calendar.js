document.addEventListener('DOMContentLoaded', function () {
  ...
  const events = [
    { date: '2024-11-02', title: 'Менторська програма', type: 'КУРС', kind: "#релігійні огранізації", details: 'Онлайн, початок о 10:00', on_offline: 'ОНЛАЙН' },
    { date: '2024-11-12', title: 'Лідерство та управління', type: 'ВЕБІНАР', kind: "#релігійні огранізації", details: 'Онлайн, початок о 14:00', on_offline: 'ОФФЛАЙН' },
    { date: '2024-11-12', title: 'Соціальне підприємництво', type: 'КУРС', kind: "#громадський сектор", details: 'Онлайн, початок о 16:00', on_offline: 'ОНЛАЙН' },
    { date: '2024-11-19', title: 'Бізнес стратегія', type: 'КУРС', kind: "#релігійні огранізації", details: 'Офлайн, початок о 10:00', on_offline: 'ОФФЛАЙН' },
    { date: '2024-11-24', title: 'Маркетинг для початківців', type: 'ВЕБІНАР', kind: "#бізнес", details: 'Онлайн, початок о 14:00', on_offline: 'ОНЛАЙН' },
  ];
...
function syncColumnWidths() {
  const cont2Columns = Array.from(document.querySelectorAll('.calendar-grid > div'));
  const cont1Columns = Array.from(document.querySelectorAll('.calendar-days > div'));
